...
TOKEN ='6598066482:AAGWDZFzYKqZw3rOCKieOkoNQ2vBDntNVuU' #"7018847010:AAEMTrqs7mZRwxyaXE_XUgbyYPYzl_Twt3M" 

niro=-1002041587417
daraii=-1002125850456
grop_id=-1002133275517
chanel_id=-1002138408979 #-1002106517139

admin=6555370485 #6926746273
...
dict_country_mid={"آمریکا":[3,4],"روسیه":[5,6], "چین":[7,8] ,"ژاپن":[9,10] ,"هند":[11,12] ,"فرانسه":[13,14],"کره جنوبی":[15,16],"ایتالیا":[17,18], "پاکستان":[19,20] ,"مصر":[21,22] ,"المان":[23,24] , "کانادا":[25,26] ,"استرالیا":[27,28], "ایران":[29,30] ,"عراق":[31,32] ,"اسرائیل":[33,34] ,"لبنان":[35,36] ,"عربستان":[37,38] ,"ترکیه":[39,40] ,"فلسطین":[41,42] ,"برزیل":[45,46] ,"اسپانیا":[43,44] ,"انگلیس":[47,48] ,"اوکراین":[49,50], "افغانستان":[51,52] ,"قزاقستان":[53,54], "سوریه":[55,56] ,"کره شمالی":[57,58] ,'پرتغال':[60,61],'فنلاند':[62,63],'مکزیک':[64,65],'مغولستان':[66,67],'یمن':[68,69],'کوبا':[70,71],'امارات':[72,73],'سوئیس':[74,75],'بروکینافاسو':[76,77],'آرژانتین':[78,79],'آذربایجان':[80,81]}#{country_name:[mid]}
userStep={}
list_country=["آمریکا","روسیه", "چین" ,"ژاپن" ,"هند" ,"فرانسه" ,"کره جنوبی","ایتالیا", "پاکستان" ,"مصر" ,"المان" , "کانادا" ,"استرالیا", "ایران" ,"عراق" ,"اسرائیل" ,"لبنان" ,"عربستان" ,"تورکیه" ,"فلسطین" ,"برزیل" ,"اسپانیا" ,"انگلیس" ,"اوکراین", "افغانستان" ,"قزاقستان", "سوریه" ,"کره شمالی",'پرتغال','فنلاند','مکزیک','مغولستان','یمن','کوبا','امارات','سوئیس','بروکینافاسو','آرژانتین','آذربایجان']
...
def country(m):
    ...
    if m.chat.type == 'private':
        if country_name in list_country:
            if cid not in dict_cid_countryname:
                if country_name not in list_country_selecting:
                    # if cid in dict_cid_countryname:
                    ...
                    bot.send_message(cid,"این کشور قبلا انتخاب شده")
                    command_start(m)
                    # bot.send_message(cid,"این کشور قبلا انتخاب شده است لطفا برای انتخاب کشور /start را بزنید")
            else:
